...
//*************************** Action Methods ***************************************//
    ...
    public void actionsMethodForMouseHover(WebElement element1, WebElement element2) {
        WebElement element_1 = element1;
        WebElement element_2 = element2;
        Actions actions = new Actions(driver);
    ...
    public WebElement waitUntilElementToBeClickable(By locator, int timeout) {
